...
SECRET_KEY = 'django-insecure-1_5m0i@pr6y^go%9kzwgvfum3t3yxj^+)kix@8z%k(3m%w-ium'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # 'rest_framework.authentication.SessionAuthentication',  # for the token authentication
    ],
}
...
APPEND_SLASH = False  # 末尾のスラッシュを削除
...
# SITE_NAME = ('XXX-MySite')

AUTH_USER_MODEL = 'accounts.UserAccount'

SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=30),  # SimpleJWT
    ...
    "AUTH_HEADER_TYPES": ('JWT',),  # SimpleJWT  ("Bearer",),
